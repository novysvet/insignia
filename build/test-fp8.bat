...
"%NVCC%" -ccbin "%HOST%" -arch=sm_89 -O3 --use_fast_math -std=c++20 -Iinclude -shared -Xlinker /IMPLIB:build\tf8x.lib src\test_fp8.cu src\fp8.cu src\dllshim.cu -o build\test-fp8.dll
